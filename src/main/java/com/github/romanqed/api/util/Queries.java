...
public class Queries {
    public static final String FANFIC_QUERY = "article.fanfic-inline";
    ...
    public static final String FANDOM_QUERY = "div.mb-15 a";
    public static final String TABLE_AUTHOR_QUERY = "tr td[style] a";
}
